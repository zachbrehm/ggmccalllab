...
As another example, this time using selections from the 12 color palette, we recreate the **Bill length vs. depth** example from the `palmerpenguins` article: https://allisonhorst.github.io/palmerpenguins/articles/examples.html
...
ggplot(
  ...
  scale_color_mnmlab(palette = "martink12") +
  labs(
